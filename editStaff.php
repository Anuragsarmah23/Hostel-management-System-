	...
	<body>
		...
		<div class="main">
			...
			<div class="bg-white p-4" style="min-height:92vh;">
				<form method="post" action="editStaffParse.php" id="validateIt" class="stdReg">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
							...
							<input type="text" name="fname" id="fname" class="form-control" placeholder="Enter father's name" data-rule-required="true" data-msg-required="Please enter the father's name" value="<?php echo $row1["fname"]; ?>">
							<div class="validation"></div>
						</div>	
					</div>
					<div class="row">
