	...
	<body>
		...
		<div class="navbar">
			<div class="row navbarContent">
				<a class="nav-link" href="index.php">EDIT STUDENT</a>
		...
		<div class="main">
			...
			<div class="bg-white p-4" style="min-height:92vh;">
				<form method="post" action="editStdParse.php" id="validateIt" class="stdReg">
					<div class="row">
						...
						<div class="col-md-6 form-group">
							...
							<input type="text" name="contact" id="contact" class="form-control" placeholder="Enter Contact Number" data-rule-required="true" data-msg-required="Please enter the contact number" data-rule-numbersonly="true" data-msg-numbersonly="Contact number should not contain any alphabet" value="<?php echo $row1['contact']; ?>">
							<div class="validation"></div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 form-group">
							...
							<input type="email" name="email" id="email" class="form-control" placeholder="Enter E-Mail ID" data-rule-required="true" data-msg-required="Please enter the email" data-rule-email="true" data-msg-email="Enter valid email address" value="<?php echo $row1['email']; ?>">
							<div class="validation"></div>
						</div>
						<div class="col-md-6 form-group">
					...
					<div class="row">
						...
						<div class="col-md-6 form-group">
							...
							<input type="date" name="dob" id="dob" max="2001-04-31" min="1990-01-01" value="<?php echo $row1['dob']; ?>" class="form-control" data-rule-required="true" data-msg-required="Please select the date of birth">
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 form-group">
							...
							<?php
								...
								$_SESSION["RID"]=$row1["RoomID"];
								$_SESSION['stdID']=$id;
								$q="select * from room where availableSeat > 0 order by availableSeat asc";
								$q_run=mysqli_query($con,$q);
								echo '<select name="roomA" id="roomA" class="form-control">
										<option value="'.$row1["RoomID"].'" selected>'.$row1["RoomID"].'</option>';
						...
						<button type="submit" class="btn btn-primary ml-auto" style="width:10%; height:50px;margin-right:12px;margin-top:25px;">UPDATE</button>
					</div>
